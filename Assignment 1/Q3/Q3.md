...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section id="states" class="content-section active">...</section>
            
            <!-- ACID Properties Section -->
            <section id="acid" class="content-section">...</section>
            
            <!-- Dirty Read Section -->
            <section id="dirty-read" class="content-section">...</section>
            
            <!-- Privileges Section -->
            <section id="privileges" class="content-section">...</section>
        </main>
    </div>
...
/* Component Styles */
.state-machine { /* Transaction state visualization */ }
.acid-grid { /* ACID properties layout */ }
.dirty-read-container { /* Concurrency issue demo */ }
.privileges-container { /* Access control interface */ }
...
let userPrivileges = {
    admin: { accounts: ['SELECT', 'INSERT', 'UPDATE', 'DELETE'] },
    alice: { accounts: ['SELECT', 'UPDATE'] },
    bob: { accounts: ['SELECT'] }
};
...
class TransactionSimulator {
    ...
    simulateFailure() { /* System crash simulation */ }
    
    // ACID Demonstrations
    simulateBankTransfer(amount) { /* Atomicity demo */ }
    simulateWithdrawal(amount) { /* Consistency demo */ }
    simulateIsolation() { /* Isolation demo */ }
    simulateCrash() { /* Durability demo */ }
    
    // Concurrency Control
    handleTransactionOperation(txId, operation) { /* Dirty read simulation */ }
    
    // Privilege Management
    selectUser(user) { /* User selection */ }
    updatePrivilegeUI() { /* Update privilege display */ }
    handlePrivilegeAction(action) { /* GRANT/REVOKE operations */ }
    testAccess() { /* Permission testing */ }
    
    // Utility Functions
    addLogEntry(message) { /* Transaction logging */ }
